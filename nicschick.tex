...
\address{Grafinger Str. 15e}{85567 Grafing b. München}{Germany}% optional, remove / comment the line if not wanted; the "postcode city" and "country" arguments can be omitted or provided empty
\phone[mobile]{+49~1717~741~741}                   % optional, remove / comment the line if not wanted; the optional "type" of the phone can be "mobile" (default), "fixed" or "fax"
% \phone[fixed]{+2~(345)~678~901}
% \phone[fax]{+3~(456)~789~012}
\email{career@nicschick.com}                               % optional, remove / comment the line if not wanted
\homepage{www.nicschick.com}                         % optional, remove / comment the line if not wanted

% Social icons
\social[linkedin]{nicschick}                        % optional, remove / comment the line if not wanted
% \social[xing]{john\_doe}                           % optional, remove / comment the line if not wanted

\social[github]{nicschick}                              % optional, remove / comment the line if not wanted
